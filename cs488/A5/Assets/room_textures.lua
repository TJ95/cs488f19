...
nocolor = gr.material({0.1, 0.1, 0.1}, {0.9, 0.9, 0.9}, 25, 0.0,0)
...
transparentSphere2:set_material(nocolor)
transparentSphere2:set_texture('Assets/earth.png')
transparentSphere2:scale(2,2,2)
transparentSphere2:translate(3, 0, -8)

transparentSphere3 = gr.sphere('transparentSphere')
scene:add_child(transparentSphere3)
transparentSphere3:set_material(nocolor)
transparentSphere3:set_texture('Assets/BeachBallColor.png')
transparentSphere3:scale(2,2,2)
transparentSphere3:rotate('X',90)
transparentSphere3:translate(-3, 4, -8)

transparentSphere4 = gr.sphere('transparentSphere')
scene:add_child(transparentSphere4)
transparentSphere4:set_material(nocolor)
transparentSphere4:set_texture('Assets/Basketball_texture.png')
transparentSphere4:scale(2,2,2)
transparentSphere4:translate(-3, -1, -7)

floor = gr.plane('floor')
scene:add_child(floor)
floor:set_material(nocolor)
floor:set_texture("Assets/brickwall.png")
...
leftwall:set_texture("Assets/brickwall.png")
...
rightwall:set_material(nocolor)
rightwall:set_texture("Assets/brickwall.png")
...
topwall:set_material(nocolor)
topwall:set_texture("Assets/brickwall.png")
...
white_light = gr.light({0, 3, 15}, {0.8, 0.8, 0.8}, {1, 0, 0})
...
gr.render(scene, 'room_textures.png', 512, 512,
