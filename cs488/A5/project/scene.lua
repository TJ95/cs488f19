-- Red/green test room
gold = gr.material(	 {0.9, 0.8, 0.4}, 	{0.8, 0.8, 0.4}, 	25, 0.9 ,0)
...
white_spherical_light2 = gr.sphericallight({0, 28, 20}, {1, 1, 1}, {1, 0, 0}, 0.5)

gr.render(scene, 'scene.png', 1024, 1024,
	  {0, 0, 30}, {0, 0, -1}, {0, 1, 0}, 50,
	  {0.4, 0.4, 0.4}, {white_spherical_light2})
