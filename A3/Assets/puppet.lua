...
elbow_joint_L:translate(0.0,-1.2,0.0)
...
head:scale(1.0/0.2,1/0.4,1.0/0.2)
...
thigh_L:scale(1/0.6,1/0.2,2.0)
thigh_L:set_material(blue)
thigh_L:scale(0.25,0.6,0.25)
thigh_L:translate(-0.7,-2.1,0.0)
...
thigh_L:add_child(calf_L)
calf_L:set_material(blue)
calf_L:scale(0.8,1.0,0.8)
calf_L:translate(0.0,-1.5,0.0)

-- joint #12, ankle_L
ankle_L = gr.joint('ankle_L', {-20, 0, 20}, {10, 0, 60})
